window.addEventListener('load', function () {
  ...
  email.addEventListener('blur', function () {
    ...
    if (inputValue.trim() == '' || !inputValue.includes('@')) {
      ...
      if (!document.querySelector('#email-error')) {
        //Lanza el mensaje de error encima del input

        let label = document.querySelector('label[for="mail"]');
        label.innerHTML +=
          '<p class="validation-error" id="email-error">Ingrese un email correcto</p>';
      }
  ...
  password.addEventListener('blur', function () {
    ...
    if (inputValue.trim() == '') {
      ...
      if (!document.querySelector('#pass-error')) {
        //Lanza el mensaje de error encima del input si no lo tiene

        let label = document.querySelector('label[for="password"]');
        label.innerHTML +=
          '<p class="validation-error" id="pass-error">Este campo es obligatorio</p>';
      }
  ...
  password.addEventListener('keyup', function () {
    ...
    if (passLength < 8) {
      ...
      if (!document.querySelector('#pass-length')) {
        //Lanza el mensaje de error encima del input si no lo tiene

        let label = document.querySelector('label[for="password"]');
        label.innerHTML +=
          '<p class="validation-error" id="pass-length">Debe ingresar al menos 8 caracteres</p>';
      }
    } else {
      document.querySelector('#pass-length').remove();
      password.style.border = 'black 1px solid';
    ...
    if (!inputValue.match(lowerCaseLetters)) {
      ...
      if (!document.querySelector('#pass-lowercase')) {
        //Lanza el mensaje de error encima del input si no lo tiene

        let label = document.querySelector('label[for="password"]');
        label.innerHTML +=
          '<p class="validation-error" id="pass-lowercase">Debe ingresar al menos 1 caracter en minúscula</p>';
      }
    } else {
    ...
    if (!inputValue.match(upperCaseLetters)) {
      ...
      if (!document.querySelector('#pass-uppercase')) {
        //Lanza el mensaje de error encima del input si no lo tiene

        let label = document.querySelector('label[for="password"]');
        label.innerHTML +=
          '<p class="validation-error" id="pass-uppercase">Debe ingresar al menos 1 caracter en mayúscula</p>';
      }
    } else {
  ...
  user_name.addEventListener('blur', function () {
    ...
    if (length <= 1) {
      ...
      if (!document.querySelector('#user-error')) {
        //Lanza el mensaje de error encima del input

        let label = document.querySelector('label[for="user_name"]');
        label.innerHTML +=
          '<p class="validation-error" id="user-error">Debe ingresar al menos 2 caracteres</p>';
      }
  ...
  name.addEventListener('blur', function () {
    ...
    if (length <= 1) {
      ...
      if (!document.querySelector('#name-error')) {
        ...
        label.innerHTML +=
          '<p class="validation-error" id="name-error">Debe ingresar al menos 2 caracteres</p>';
      }
  ...
  last_name.addEventListener('blur', function () {
    ...
    if (length <= 1) {
      ...
      if (!document.querySelector('#last-name-error')) {
        //Lanza el mensaje de error encima del input

        let label = document.querySelector('label[for="last_name"]');
        label.innerHTML +=
          '<p class="validation-error" id="last-name-error">Debe ingresar al menos 2 caracteres</p>';
      }
